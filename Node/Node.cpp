...
ostream& operator<<(ostream& os, const Node& node){
    ...
    os << "North :  " << node.North << "North Value :  "<< node.North->getValue()<< endl ;
    os << "North_East :  " << node.North_East<< "North_East Value :  "<< node.North_East->getValue()<< endl ;
    os << "East :  " << node.East << "East Value :  "<< node.East->getValue()<< endl ;
    os << "South_East :  " << node.South_East << "South_East Value :  "<< node.South_East->getValue()<< endl ;
    os << "South :  " << node.South << "South Value :  "<< node.South->getValue()<< endl ;
    os << "South_West :  " << node.South_West << "South_West Value :  "<< node.South_West->getValue()<< endl ;
    os << "West :  " << node.West << "West Value :  "<< node.West->getValue()<< endl ;
    os << "North_West :  " << node.North_West << "North_West Value :  "<< node.North_West->getValue()<< endl ;
    return os;
}